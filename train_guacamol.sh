...
python train/train.py --run_name logp_scaffold_guacamol --data_name guacamol2 --scaffold --batch_size 384 --num_props 1 --max_epochs 10 --property logp

python train/train.py --run_name logp_sas_scaffold_guacamol --data_name guacamol2 --scaffold --batch_size 384 --num_props 2 --max_epochs 10 --property logp sas